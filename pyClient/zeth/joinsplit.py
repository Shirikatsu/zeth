...
class ZethClient:
    ...
    def deploy_zion(
        ...
        print("[INFO] 3. VK written, deploying smart contracts...")
        # Uses Groth16 by default
        mixer_interface = contracts.compile_mixer_zion()
        mixer_instance = contracts.deploy_mixer_zion(
            web3,
            mk_tree_depth,
            mixer_interface,
            vk_json,
    ...
    def zion_initiate(
        ...
        wei_pub_value: int,
        call_gas: int) -> str:
        return contracts.zion_initiate(
            self.mixer_instance,
            pk_sender,
            ciphertext1,
            ciphertext2,
